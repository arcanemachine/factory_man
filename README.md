...
For Ecto schema factories, `params_for_*` and `string_params_for_*` functions build a struct
and strip Ecto metadata, returning a clean map for changesets or controller tests:
